...
export const DEMO_ACTIVITY_LOGS = [
  ...
  },
  {
    ...
    entity_type: 'task',
    entity_id: 'demo-task-005',
    metadata: { title: '실시간 알림 기능 구현', field: 'column', from: 'To Do', to: 'In Progress' },
    created_at: isoAgo(5),
  },
  {
    id: 'demo-log-004',
    ...
    metadata: { title: '프로젝트 초기 설정', field: 'column', from: 'In Progress', to: 'Done' },
    created_at: isoAgo(12),
  },
  {
    id: 'demo-log-005',
  ...
  },
  {
    ...
    metadata: { title: 'OAuth 로그인 구현', field: 'column', from: 'In Progress', to: 'Done' },
    created_at: isoAgo(8),
  },
  {
    id: 'demo-log-007',
